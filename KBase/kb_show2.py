...
outp = open('SZDLKF_cropus.txt', 'w', encoding='utf8')
...
infile = 'SZDLKF_cropus.txt'
outfile = 'SZDLKF_cropus.cut.txt'
...
infile = 'SZDLKF_cropus.cut.txt'
outfile = 'SZDLKF_cropus.analyse.txt'
