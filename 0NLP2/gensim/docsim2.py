...
# 读取文件
raw_documents=[]
walk = os.walk(os.path.realpath("../data/199801.txt"))
...
f = open("../data/IT.txt", 'r', encoding='utf8')
raw = f.read()
raw_documents.append(raw)
...
similarity = similarities.Similarity('../tmp/-Similarity-index', corpus, num_features=999999999)

test_data_1 = '如何在GIS中关闭设备树'
