...
# 训练样本
raw_documents = []
with open("../data/IT_Q.txt", 'r', encoding='utf-8') as src:
    for inline in src:
...
dictionary.save('../tmp/IT_Q.dict')
# print(dictionary.token2id)

# 生成语料库
corpus = [dictionary.doc2bow(text) for text in corpora_documents]
# 序列化
corpora.MmCorpus.serialize('../tmp/IT_Q_corpus.mm', corpus)
# 重新加载预料
new_corpus = corpora.MmCorpus('../tmp/IT_Q_corpus.mm')
...
similarity = Similarity('../tmp/IT-Similarity-index', corpus, num_features=1024)
