...
# 训练样本
raw_documents = []
with open("../data/FAQ.txt", 'r', encoding='utf-8') as src:
    for inline in src:
...
dictionary.save('../tmp/FAQ.dict')
# print(dictionary.token2id)

# 生成语料库
corpus = [dictionary.doc2bow(text) for text in corpora_documents]
# 序列化
corpora.MmCorpus.serialize('../tmp/FAQ_corpus.mm', corpus)
# 重新加载预料
new_corpus = corpora.MmCorpus('../tmp/FAQ_corpus.mm')
...
similarity = Similarity('../tmp/FAQ-Similarity-index', corpus, num_features=400)
