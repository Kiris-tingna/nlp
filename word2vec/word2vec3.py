...
WORD2VEC_LIST = [
  (0, 'SZDLKF_answer_SG_s400_w5_m5.word2vec', Word2Vec(size=400, window=5, min_count=5, workers=CPU_COUNT)),
  (1, 'SZDLKF_answer_SG_s800_w6_m5_n3_s1e5.word2vec', Word2Vec(sg=1, size=800, window=6, min_count=5, negative=3, sample=0.001, hs=1, workers=CPU_COUNT)),
  (2, 'SZDLKF_answer_CBOW_s800_w3_m5_n3_s1e3.word2vec', Word2Vec(sg=0, size=800, window=3, min_count=5, negative=3, sample=0.001, hs=1, workers=CPU_COUNT)),
]
...
def main():
  ...
  if not os.path.exists(output_file):
    ...
    test_model('exam_words.txt', output_file)
